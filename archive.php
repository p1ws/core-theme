	...
	<div id="main__container" class="container--slim">
		...
		<div class="xs--1 md--3of4">
			...
			<article id="post-<?php the_ID(); ?>" class="main--article">
				<h1 class="main--article__title">Category: <?php echo single_cat_title(); ?></h1>
			</article>

			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
			<article id="post-<?php the_ID(); ?>" class="post-block flexrow xs--around md--between">
				<!-- .vertical -->
