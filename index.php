						...
						<article id="post-<?php the_ID(); ?>" class="main--article">
							<h1 class="main--article__title">
								<?php 
									...
									$seotitle = get_field('seo_h1_title','$page_for_posts');
									if ($seotitle) {
										echo the_field('seo_h1_title','37');
									}
									else {
						...
						<article id="post-<?php the_ID(); ?>" class="post-block flexrow"> <!-- .vertical -->
							...
							<div class="post-block__image xs--1 md--1of3">
								...
								<?php
									...
									<img src="<?php bloginfo('template_directory'); ?>/library/images/blog-placeholder.png" alt="<?php the_title(); ?>" />
								<?php } ?>	
							</div>
